---
title: "Easier Command Line Applications"
...
A few days ago, Posit announced the release of [Rapp 0.3.0](https://github.com/r-lib/Rapp), which is an R package that makes it "straightforward to build polished CLI applications from simple R scripts," which I find very useful, even if I don't have a use case for it right now, but I know I will eventually. 
